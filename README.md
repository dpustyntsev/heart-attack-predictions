...
## Описание
Приложение на FastAPI для предсказания риска сердечного приступа на основе CSV-файлов с данными пациентов.  
API принимает путь к CSV-файлу и возвращает предсказания для каждой строки данных.
